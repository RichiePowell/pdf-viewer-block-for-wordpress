        ...
        el(
          ...
          el(
            ...
            el(
              "p",
              {},
              i18n.__("Click on the PDF icon to replace the PDF file.")
            ),
            el(
              "p",
              {},
              i18n.__(
                "The PDF Viewer's size is 100% / 700px by default. You can set custom (pixels) size below."
              )
            ),
            el(TextControl, {
              type: "number",
          ...
          el(
            "div",
            {
              className: attributes.mediaID
                ? "pdf-viewer pdf-upload-active"
                : "pdf-viewer pdf-upload-inactive",
                ...
                return el(
                  ...
                  !attributes.mediaID
                    ...
                    : el("a", {
                        ...
                        "data-width": attributes.mediaWidth
                          ? attributes.mediaWidth
                          : "",
                        "data-height": attributes.mediaHeight
                          ? attributes.mediaHeight
                          : "",
                      })
                );
              },
